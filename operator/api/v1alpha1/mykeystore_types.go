...
type MyKeyStoreSpec struct {
	...
	// Size defines the number of MyKeyStore instances
...
type MyKeyStoreStatus struct {
	// Represents the observations of a MyKeyStore's current state.
	// MyKeyStore.status.conditions.type are: "Available", "Progressing", and "Degraded"
	// MyKeyStore.status.conditions.status are one of True, False, Unknown.
	// MyKeyStore.status.conditions.reason the value should be a CamelCase string and producers of specific
	// condition types may define expected values and meanings for this field, and whether the values
	// are considered a guaranteed API.
	// MyKeyStore.status.conditions.Message is a human readable message indicating details about the transition.
