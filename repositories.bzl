...
def go_repositories():
    ...
    go_repository(
        name = "io_k8s_sigs_controller_runtime_tools_setup_envtest",
        build_file_proto_mode = "disable_global",
        importpath = "sigs.k8s.io/controller-runtime/tools/setup-envtest",
        sum = "h1:xYNzzoK+cwgBnaRqrYFLQCSwMAYcR6a06gf3FJ369Kw=",
        version = "v0.0.0-20230926180527-c93e2abcb28e",
    )
